...
export function PCProximityPrompt({ onLaunch }: PCProximityPromptProps) {
  return (
    <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10">
      <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#1a1a2e]/95 border border-[#e94560]/50 shadow-lg shadow-[#e94560]/20 backdrop-blur-sm">
        <Monitor size={16} className="text-[#e94560] shrink-0" />
